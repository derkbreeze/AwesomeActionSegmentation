...
${\color{blue}Ordered\ transcript\ supervised}$
...
${\color{magenta}Timestep\ supervised}$
...
${\color{green}Unordered\ transcript\ supervised}$
...
- Mohsen Fayyaz, Jurgen Gall. Sct: Set constrained temporal transformer for set supervised action segmentation, CVPR2020. 
...
## CrossTask
- Dimitri Zhukov, Jean-Baptiste Alayrac, Ramazan Gokberk Cinbis, David Fouhey, Ivan Laptev, Josef Sivic. Cross-task weakly supervised learning from instructional videos, CVPR2019.
[[pdf](https://openaccess.thecvf.com/content_CVPR_2019/papers/Zhukov_Cross-Task_Weakly_Supervised_Learning_From_Instructional_Videos_CVPR_2019_paper.pdf)]
